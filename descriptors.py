...
####################################################
#    These descriptors are for the minimum distance
####################################################
...
####################################################
#    These descriptors are for the perceptron
####################################################

def flat_descriptor_1(array):
    """ this is the easiest descriptor but the longest

        it transforms a bidimiensinal array to a 1 dimension array.
    """
    return (np.concatenate(
                           (array.flatten().astype(np.int32),
                           array.T.flatten().astype(np.int32))))
    
    
def flat_descriptor_2(array):
    """
        Another descriptor. 
    ...
    return np.concatenate((sum_of_cols, sum_of_rows))


def flat_descriptor_3(array):
    """
