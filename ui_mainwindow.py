...
#
# Created: Wed Aug 21 22:07:40 2013
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tabPerceptron = QtGui.QWidget()
        self.tabPerceptron.setObjectName(_fromUtf8("tabPerceptron"))
        self.widgetPerceptron = Perceptron(self.tabPerceptron)
        self.widgetPerceptron.setGeometry(QtCore.QRect(10, 10, 640, 560))
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.widgetPerceptron.sizePolicy().hasHeightForWidth())
        self.widgetPerceptron.setSizePolicy(sizePolicy)
        self.widgetPerceptron.setMinimumSize(QtCore.QSize(0, 0))
        self.widgetPerceptron.setObjectName(_fromUtf8("widgetPerceptron"))
        self.tabWidget.addTab(self.tabPerceptron, _fromUtf8(""))
        self.tabAdaline = QtGui.QWidget()
        self.tabAdaline.setObjectName(_fromUtf8("tabAdaline"))
        self.widgetPerceptron_2 = ImageEditor(self.tabAdaline)
        self.widgetPerceptron_2.setGeometry(QtCore.QRect(10, 10, 640, 560))
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.widgetPerceptron_2.sizePolicy().hasHeightForWidth())
        self.widgetPerceptron_2.setSizePolicy(sizePolicy)
        self.widgetPerceptron_2.setMinimumSize(QtCore.QSize(0, 0))
        self.widgetPerceptron_2.setObjectName(_fromUtf8("widgetPerceptron_2"))
        self.tabWidget.addTab(self.tabAdaline, _fromUtf8(""))
        self.tabImageCreator = QtGui.QWidget()
        self.tabImageCreator.setObjectName(_fromUtf8("tabImageCreator"))
        self.widgetImageCreator = ImageEditor(self.tabImageCreator)
        self.widgetImageCreator.setGeometry(QtCore.QRect(9, 9, 641, 571))
        self.widgetImageCreator.setObjectName(_fromUtf8("widgetImageCreator"))
        self.tabWidget.addTab(self.tabImageCreator, _fromUtf8(""))
        self.widget_iconeditor = IconWidget(self.centralwidget)
        self.widget_iconeditor.setGeometry(QtCore.QRect(700, 40, 240, 240))
        ...
        self.groupBox_descriptor = QtGui.QGroupBox(self.centralwidget)
        self.groupBox_descriptor.setGeometry(QtCore.QRect(700, 430, 254, 111))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabPerceptron), _translate("MainWindow", "Perceptron", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabAdaline), _translate("MainWindow", "Adaline", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabImageCreator), _translate("MainWindow", "ImageCreator", None))
